...
(function (root) {
  ...
  /**
   * Sign-in must never hang. An un-timed await on the popup flow leaves a
   * button disabled with nothing visible happening — which reads as "the
   * button does nothing" and leaves the user nothing to act on.
   */
