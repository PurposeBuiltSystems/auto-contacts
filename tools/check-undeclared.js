 ...
 *
 * The list used to name src, src/taskpane and src/commands. When src/mobile
 * was added it was simply not checked — the tool reported success over a set
 * that quietly excluded the newest code, which is the worst way for a linter
 * to fail. Walking means a new directory is covered the day it appears.
 */
